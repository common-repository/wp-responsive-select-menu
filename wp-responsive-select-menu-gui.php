	...
	<div class="wrap">
		<?php
			if(isset($_POST['submit'])) 
			{
				...
				if(isset($_POST['slide_side']))
				{
				$slide_side ='';
				$slide_side = sanitize_text_field($_POST['slide_side']);
				update_option('slide_side', $slide_side);
				}
				if(isset($_POST['search_position']))
				{
				$search_position ='';
				$search_position =  sanitize_text_field($_POST['search_position']);
				update_option('search_position', $search_position );
				}
				if(isset($_POST['menu_breakpoint']))
				{
				$menu_breakpoint ='';
				$menu_breakpoint=sanitize_text_field($_POST['menu_breakpoint']);
				...
				if(isset($_POST['menu_hide']))
				{
				$menu_hide ='';
				$menu_hide=sanitize_text_field($_POST['menu_hide']);
				update_option('menu_hide', $menu_hide );
				}
				if(isset($_POST['bar_bg']))
				{
				$bar_bg ='';
				$bar_bg=sanitize_text_field($_POST['bar_bg']);
				update_option('bar_bg', $bar_bg );
				}
				if(isset($_POST['menu_bg']))
				{
				$menu_bg ='';
				$menu_bg=sanitize_text_field($_POST['menu_bg']);
				update_option('menu_bg', $menu_bg );
				}
				if(isset($_POST['menu_hover_bg']))
				{
				$menu_hover_bg ='';
				$menu_hover_bg=sanitize_text_field($_POST['menu_hover_bg']);
				update_option('menu_hover_bg', $menu_hover_bg );
				}
				if(isset($_POST['menu_title_color']))
				{
				$menu_title_color ='';
				$menu_title_color=sanitize_text_field($_POST['menu_title_color']);
				update_option('menu_title_color', $menu_title_color );
				}
				if(isset($_POST['menu_link_color']))
				{
				$menu_link_color ='';
				$menu_link_color=sanitize_text_field($_POST['menu_link_color']);
				update_option('menu_link_color', $menu_link_color );
				}
				if(isset($_POST['menu_linkhover_color']))
				{
				$menu_linkhover_color ='';
				$menu_linkhover_color=sanitize_text_field($_POST['menu_linkhover_color']);
				update_option('menu_linkhover_color', $menu_linkhover_color );
				}
				if(isset($_POST['submenu_arrow_color']))
				{
				$submenu_arrow_color ='';
				$submenu_arrow_color = sanitize_text_field($_POST['submenu_arrow_color']);
